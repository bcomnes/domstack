 ...
 * @param {string[] | null | undefined} [opts.ignore] - Array of file/folder patterns to ignore during the walk.
 * @param {boolean | null | undefined} [opts.buildDrafts=false] - Includes pages with the variable published:false when set to true
