...
export const pageWorkerSuffixs = workerExtensions.map(ext => workerSuffix + ext)

export const pageVarsNames = nodeHasTS
  ? ['page.vars.ts', 'page.vars.mts', 'page.vars.cts',
      'page.vars.js', 'page.vars.mjs', 'page.vars.cjs']
  : ['page.vars.js', 'page.vars.mjs', 'page.vars.cjs']

export const layoutSuffixs = nodeHasTS
  ? ['.layout.ts', '.layout.mts', '.layout.cts', '.layout.js', '.layout.mjs', '.layout.cjs']
  : ['.layout.js', '.layout.mjs', '.layout.cjs']

export const layoutClientSuffixs = [
...
export const templateSuffixs = nodeHasTS
...
export const globalClientNames = [
...
export const serviceWorkerNames = nodeHasTS
  ? [
      'service-worker.ts', 'service-worker.mts', 'service-worker.cts',
...
export const domstackManifestSettingsNames = nodeHasTS
  ? [
      'domstack-manifest.settings.ts', 'domstack-manifest.settings.mts', 'domstack-manifest.settings.cts',
      'domstack-manifest.settings.js', 'domstack-manifest.settings.mjs', 'domstack-manifest.settings.cjs'
    ]
  : ['domstack-manifest.settings.js', 'domstack-manifest.settings.mjs', 'domstack-manifest.settings.cjs']
