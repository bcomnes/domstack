 ...
 * @param {string | undefined} [params.sourceRelname] - Source-relative path that produced this output when known.
 * @param {string | undefined} [params.entryPoint] - esbuild entry point path for bundled outputs when available.
