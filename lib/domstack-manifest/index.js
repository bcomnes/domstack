...
export async function resolveDomstackManifestOptions ({ domstackManifestSettingsPath, opts }) {
  ...
  const includeEntry = typeof /** @type {{ includeEntry?: unknown }} */ (domstackManifestSettings).includeEntry === 'function'
    ...
    : undefined
  const settingsFilename = typeof /** @type {{ filename?: unknown }} */ (domstackManifestSettings).filename === 'string'
    ? /** @type {{ filename: string }} */ (domstackManifestSettings).filename
    : undefined
  ...
  const options = {
    ...
    filename: getDomstackManifestFilename(opts, settingsFilename),
  }
 ...
 */
export function getDomstackManifestFilename (opts, fallbackFilename = DEFAULT_DOMSTACK_MANIFEST_FILENAME) {
