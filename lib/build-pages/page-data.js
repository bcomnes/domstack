  ...
  async init ({ layouts }) {
    ...
    if (!pageInfo.generated) {
      ...
      if (pageModuleOutputs && varsCompanionOutputs) {
        console.warn(`Page "${pageInfo.pageFile.filepath}" and companion "${pageVars?.filepath}" both export pageOutputs; using the page module export and ignoring the companion export`)
      }
