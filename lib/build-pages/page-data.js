...
import { resolveVars, resolvePostVars } from './resolve-vars.js' // resolvePostVars used to detect and error on postVars usage
 ...
 * @template {Record<string, any>} [T=any] - The type of variables for the page data
 * @template [U=any] U - The return type of the page function (defaults to any)
 * @template [V=string] V - The return type of the layout function (defaults to string)
 */
