 ...
 * @returns {Promise<{ render: InternalLayoutFunction<T, U, V>, vars: T }>} The resolved layout render function and optional vars exported from the module.
 */
export async function resolveLayout (layoutPath) {
  ...
  return {
    render: layout,
    vars: /** @type {T} */ (await resolveVarsExport(vars, 'Layout vars')),
  }
}
