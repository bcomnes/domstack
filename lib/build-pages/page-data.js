...
export class PageData {
  ...
  /** @type {T | null} */ #trackedVarsCache = null
  /** @type {[Partial<T>, Partial<T>, Partial<T>, Partial<T> | null, Partial<T> | null] | null} */ #varsCacheSources = null
  /** @type {string?} */ #defaultStyle = null
  /** @type {string?} */ #defaultClient = null
  /** @type {BuilderOptions} */ builderOptions
  /** @type {WatchDependencyTracker | undefined} */ #watchDependencyTracker
   ...
   * @param  {WatchDependencyTracker | undefined} [options.watchDependencyTracker] - Per-build dependency tracker.
   */
  constructor ({
    pageInfo,
    globalVars,
    ...
    this.#watchDependencyTracker = watchDependencyTracker
  ...
  get vars () {
    ...
    const sources = /** @type {[Partial<T>, Partial<T>, Partial<T>, Partial<T> | null, Partial<T> | null]} */ ([
      this.globalVars,
      this.globalDataVars,
      this.layoutVars,
      this.pageVars,
    ...
    try {
      ...
      this.#trackedVarsCache = this.#watchDependencyTracker
        ? this.#watchDependencyTracker.trackPageVars(
          this.pageInfo,
          this.#varsCache,
          layoutVars,
          pageVars,
  ...
  async init ({ layouts }) {
    ...
    this.builderVars = /** @type {Partial<T>} */ (builderVars)
