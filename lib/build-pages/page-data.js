...
import { createSubscribedData, extractDataDeps } from './watch-dependencies.js'
...
export class PageData {
  ...
  async init ({ layouts }) {
    ...
    for (const layout of this.layoutChain) {
      ...
      this.#layoutSubscriptions.set(layout.name, { keys: resolution.dataDeps, data: /** @type {D} */ (Object.freeze({})) })
