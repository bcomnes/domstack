...
export class PageData {
  ...
  /**
   * Return the global-data values declared by this page and its layout.
   *
   * @returns {D}
   */
  get data () {
  ...
  async init ({ layouts }) {
    ...
    const dependencies = new Set([...pageResolution.dataDependencies, ...builderResolution.dataDependencies])
