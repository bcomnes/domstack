 ...
 * @import { PageBuilderResult } from '../../outputs/page-writer.js'
 */
...
export async function jsBuilder ({ pageInfo }) {
  ...
  const { default: pageLayout, vars, pageOutputs } = await import(pageInfo.pageFile.filepath)
  ...
  const hook = validatePageOutputsHook(pageOutputs, pageInfo.pageFile.filepath)
  return { vars, pageLayout, pageOutputs: hook }
}
