 ...
 * @returns {Promise<BuildOutputRecord[]>}
 */
...
function extractPrecacheVars (page) {
  ...
  const vars = {}
  const source = /** @type {{ precache?: unknown, offline?: unknown }} */ (page.vars)
  if (Object.hasOwn(source, 'precache')) vars.precache = source.precache
  if (Object.hasOwn(source, 'offline')) vars.offline = source.offline
  return vars
}
