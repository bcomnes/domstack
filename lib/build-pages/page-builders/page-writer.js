 ...
 * @typedef {PageDataClass<T, U, V>} PageData
 */
 ...
 * @param {(() => Promise<string>) | undefined} [params.renderFullPage] - Optional tracked render callback.
...
export async function pageWriter ({
  ...
  const formattedPageOutput = renderFullPage
    ? await renderFullPage()
    : await page.renderFullPage({ pages })
