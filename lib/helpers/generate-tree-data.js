...
/**
 * @param {{ report?: { outputs?: BuildOutputRecord[] } } | null | undefined} result
 ...
 * @returns {Map<string, BuildOutputRecord[]>}
 */
function groupOutputsBySource (outputs) {
  /** @type {Map<string, BuildOutputRecord[]>} */
...
/**
 * @param {BuildOutputRecord} output
 */
