/**
 * @import { BuildOutputReport, BuildStep, BuildStepResult } from '../builder.js'
 */
import { copy } from 'cpx2'
import { createCopiedDomstackManifestRecords } from '../helpers/cpx2-report.js'

/**
 * @typedef {BuildStepResult<'static', BuildOutputReport>} StaticBuildStepResult
 */

/**
 * @typedef {BuildStep<'static', BuildOutputReport>} StaticBuildStep
 */
