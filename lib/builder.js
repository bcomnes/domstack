...
/**
 * Common report shape for build steps that emit manifest output records.
 *
 * @typedef {object} BuildOutputReport
 * @property {DomstackManifestRecord[]} outputs
 */

/**
 * @typedef {BuildStepResult<string, BuildOutputReport>} BuildOutputStepResult
 */
