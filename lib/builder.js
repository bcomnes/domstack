...
/**
 * @callback DomStackLogMethod
 * @param {...any} args
 * @returns {void}
 */

/**
 * Structural logger contract accepted by DOMStack.
 *
 * Pino loggers satisfy this interface without exposing Pino's implementation
 * dependencies through DOMStack's public declarations.
 *
 * @typedef DomStackLogger
 * @property {DomStackLogMethod} trace
 * @property {DomStackLogMethod} debug
 * @property {DomStackLogMethod} info
 * @property {DomStackLogMethod} warn
 * @property {DomStackLogMethod} error
 * @property {DomStackLogMethod} fatal
 * @property {(bindings: Record<string, unknown>) => DomStackLogger} child
 */
 ...
 * @property {DomStackLogger|undefined} [logger] - Pino-compatible logger used for watch output and embedded sync output.
 */
...
/**
 * @param {...(BuildOutputStepResult | null)} results
